...
def calculate_global_path_prediction(
    ...
    """Combine adjusted category and conditional sub-category scores."""
    ...
    if (
        ...
        or any(column not in adjusted_primary_df.columns for column in required_primary_columns)
        or any(column not in conditional_sub_df.columns for column in required_sub_columns)
    ):
